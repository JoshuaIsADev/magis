...
function FilterSort() {
  ...
  return (
    <>
      <Column $variation='filterSortButton'>
        <Button
          $variation='menu'
      ...
      >
        ...
        <Button
          ...
          className={searchParams.get('category') === 'Chair' ? 'selected' : ''}
        >
          Chairs
        </Button>
        <Button
          onClick={() => handleFilterCategory('Table')}
          className={searchParams.get('category') === 'Table' ? 'selected' : ''}
        >
          Tables
        </Button>
        <Button
          onClick={() => handleFilterCategory('Sofa')}
          className={searchParams.get('category') === 'Sofa' ? 'selected' : ''}
        >
          Sofa
        </Button>
      </Column>
      ...
      >
        ...
        <Button
          ...
          className={
            searchParams.get('designer') === 'Jasper Morrison' ? 'selected' : ''
          }
        >
          Jasper Morrison
        </Button>
        <Button
          ...
          className={
            searchParams.get('designer') === 'Marcel Wanders' ? 'selected' : ''
          }
        >
          Marcel Wanders
        </Button>
      ...
      >
        ...
        <Button
          ...
          className={searchParams.get('material') === 'glass' ? 'selected' : ''}
        >
          Glass
        </Button>
        <Button
